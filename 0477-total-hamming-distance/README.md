<h2><a href="https://leetcode.com/problems/total-hamming-distance/?envType=company&envId=apple&favoriteSlug=apple-six-months">477. Total Hamming Distance</a></h2><h3>Medium</h3><hr><p>The <a href="https://en.wikipedia.org/wiki/Hamming_distance" target="_blank">Hamming distance</a> between two integers is the number of positions at which the corresponding bits are different.</p>
